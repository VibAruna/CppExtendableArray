...
class ResArray
{
    public:
        ...
        * Ret   : None
        ******************************************************************************************************/
        void update(unsigned int index, const T& element);
    ...
    private:
        ...
        /******************************************************************************************************
		* Func  : extendArray
		* Desc  : Extends array by step size
		* Param : None
		* Ret   : None
		******************************************************************************************************/
		void extendArray();
...
template <class T>
void ResArray<T>::update(unsigned int index, const T& element)
{
    if (index >= length)
    {
        ArrayIndexOutOfBoundException ex(index, length);
...
//    else if(length == arr_length) //checks whether the current array is totally filled.
//    {
//    	this->extendArray();
//    }
